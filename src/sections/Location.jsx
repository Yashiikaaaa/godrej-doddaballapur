      ...
      <div className="w-full flex flex-col md:flex-row items-center py-7 md:py-14 gap-6 md:gap-14">
        ...
        <div className="flex flex-col items-center md:items-start w-full px-6 md:pl-[7.5rem] md:justify-between gap-6 text-center md:text-left lg:max-w-lg"> 
          ...
          <div className="text-center md:text-left w-fit">
            <Button 
              ...
              onClick={() => window.open("https://maps.app.goo.gl/LcSApy8so47ioeQD8", "_blank")} // Opens Google Maps link in a new tab
            />
          </div>
        </div>
              {/* Google Maps Iframe */}
        <div className="w-full flex justify-center">
          <div className="w-full max-w-4xl aspect-w-16 aspect-h-9 min-h-[60vh]">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d236558.31688975327!2d77.36164177037134!3d13.268541497040014!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bb1ddb95b75840f%3A0xcc2f7dccd7742fb0!2sGodrej%20Doddaballapura!5e1!3m2!1sen!2sin!4v1759310655261!5m2!1sen!2sin"
